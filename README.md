...
> A native, open-source desktop simulation suite. CFD, FEA, EM,
> molecular dynamics, quantum chemistry, bioinformatics, CRISPR
> design, and more — written in Rust, no browser, no subscription,
> no vendor lock-in.
