...
- Curated deep review of ~50 marquee algorithm files: DFT, FM-index,
  haplotype caller, Bayesian phylogenetics,
...
50 files read carefully (the marquee algorithm files). The
