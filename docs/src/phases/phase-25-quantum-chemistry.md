...
The implementation rode subagent-driven-development across 5 discrete
...
Python-script-subprocess shape for PySCF). See the out-of-scope
section of `docs/superpowers/plans/2026-04-30-quantum-chemistry.md`
