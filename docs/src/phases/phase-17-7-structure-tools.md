...
mmCIF reader) remains a separate deferred docs-cleanup phase. See
the out-of-scope section of `docs/superpowers/plans/2026-05-02-
structure-tools.md` for the full follow-up phase list.
