...
binary subprocess shape (PLUMED / cpptraj sister tools). See the
out-of-scope section of `docs/superpowers/plans/2026-04-30-md-
analysis.md` for the full follow-up phase list.
