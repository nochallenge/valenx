...
Python-script subprocess shape (HOOMD-blue sister tools). See the
out-of-scope section of `docs/superpowers/plans/2026-05-02-md-
engines.md` for the full follow-up phase list.
