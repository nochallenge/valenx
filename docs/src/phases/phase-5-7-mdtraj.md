...
The implementation rode subagent-driven-development across 3
...
(PLUMED / cpptraj sister tools). See the out-of-scope section of
`docs/superpowers/plans/2026-05-02-mdtraj.md` for the full follow-
up phase list.
