...
//!
//! Round 6 Block 13 of the Valenx roadmap — a Round 6 *extension* that
...
//!
//! It builds on three Round 6 crates and never duplicates them:
//!
//! - [`valenx_genomics`] (Block 6.10) — its CRISPR PAM scanner
...
//! - [`valenx_rnastruct`] (Block 6.5) — the Zuker minimum-free-energy
...
//! - No `cargo test` is ever run here per the project lockdown —
//!   tests are compile-checked by `cargo clippy --all-targets` only,
//!   never executed.
