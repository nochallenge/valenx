...
pub use beam::{
    ...
    cantilever_udl_tip_slope, circular_polar_second_moment_of_area,
    ...
    fixed_fixed_udl_end_moment, flexural_rigidity, polar_section_modulus,
    rectangular_plastic_section_modulus, rectangular_second_moment_of_area,
