...
pub use beam::{
    ...
    cantilever_udl_tip_deflection, euler_bernoulli_beam_frequency,
    simply_supported_center_deflection, simply_supported_udl_center_deflection, solve_beam_modal,
