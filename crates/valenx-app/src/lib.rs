...
pub struct ValenxApp {
    ...
    /// Round 6 — whether the right-side Genetics Workbench panel is
    ...
    /// (one per Round-6 computational-biology crate). See
    /// [`crate::genetics_workbench`].
    pub(crate) genetics: crate::genetics_workbench::GeneticsWorkbenchState,

    /// Round 6 Block 15 — whether the right-side Aerodynamics / Wind
