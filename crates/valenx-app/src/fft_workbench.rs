        ...
        |app, ui| {
            ...
            egui::ScrollArea::vertical()
                ...
                .show(ui, |ui| {
                    ...
                    ui.horizontal(|ui| {
                        let cap = ui.label("sample rate fs (Hz)");
                    ...
                    ui.horizontal(|ui| {
                        let cap = ui.label("frequency f0 (Hz)");
                        ui.add(egui::DragValue::new(&mut s.tone_hz).speed(1.0))
                            .labelled_by(cap.id);
                    });
                    ui.horizontal(|ui| {
                        let cap = ui.label("amplitude A");
...
mod headless_ui_tests {
    ...
    fn numeric_controls_are_named_and_associated() {
        ...
        for caption in ["samples N", "frequency f0 (Hz)"] {
            assert!(
