        ...
        |app, ui| {
            ...
            egui::ScrollArea::vertical()
                ...
                .show(ui, |ui| {
                    ...
                    ui.horizontal(|ui| {
                        let l = ui.label("present PF cos φ₁");
                    ...
                    ui.horizontal(|ui| {
                        let l = ui.label("target PF cos φ₂");
...
mod headless_ui_tests {
    ...
    fn numeric_controls_are_named_and_associated() {
        ...
        for caption in ["real power P (W)", "present PF cos φ₁", "target PF cos φ₂"] {
            assert!(
