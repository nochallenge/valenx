...
pub fn draw_refrigeration_workbench(app: &mut ValenxApp, ctx: &egui::Context) {
    ...
    let close = crate::workbench_chrome::workbench_shell(
        app,
        ctx,
        "valenx_refrigeration_workbench",
        "Refrigeration",
        |app, ui| {
            ui.label(
                egui::RichText::new("native vapor-compression / Carnot COP · valenx-refrigeration")
                    .weak()
                    .small(),
            );
            ui.separator();
            ...
            egui::ScrollArea::vertical()
                ...
                .show(ui, |ui| {
                    ...
                    ui.horizontal(|ui| {
                        let l = ui.label("cooling load (kW)");
...
mod headless_ui_tests {
    ...
    fn numeric_controls_are_named_and_associated() {
        ...
        for caption in ["cold Tc (K)", "h1 evap. outlet", "cooling load (kW)"] {
            assert!(
