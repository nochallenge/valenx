...
//!
//! An *extension* that
//! turns the scattered RNA-design capability of the sibling
//! crates into one guided, start-to-finish workflow.
//!
//! **This crate orchestrates; it does not reimplement folding.** The
//! sibling crates ship the RNA building blocks — this crate is the
//! integration layer on top of them:
//!
//! - [`valenx_rnastruct`] — RNA secondary structure: Zuker
...
//! - [`valenx_genediting`] — mRNA-therapeutic design: the
