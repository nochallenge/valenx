...
//!
//! Round 6 Block 10 of the Valenx roadmap. A native-Rust replacement
...
//! v1s, not SPAdes / hifiasm at scale. No `cargo test` is ever run
//! here per the project lockdown — tests are compile-checked only.
