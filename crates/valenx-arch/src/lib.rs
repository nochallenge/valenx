...
pub use structural::{
    ...
    StructuralElement, StructuralLoad, StructuralMaterial, StructuralMember, StructuralModel,
    StructuralModelOptions, StructuralNode, StructuralSection, StructuralSupport, SupportKind,
};
